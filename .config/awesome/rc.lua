...
-- beautiful.init(string.format("%s/.config/awesome/default/themes/%s/theme.lua", os.getenv("HOME"), chosen_theme))
beautiful.init(string.format("~/.config/awesome/default/theme.lua"))
