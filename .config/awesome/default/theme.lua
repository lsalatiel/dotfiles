...
theme.wallpaper                                 = "~/.config/awesome/default/wallpapers/fishs.png"
theme.font                                      = "Jet Brains Mono 10"
...
local volume_str = wibox.widget.textbox("VOL")
local battery_str = wibox.widget.textbox("BAT")
